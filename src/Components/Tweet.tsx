...
const Tweet = (props: ITweetProps) => {
  const { owner, username, timeStamp, imageUrl, tweetContent, commentNumber, favNumber, rtNumber } = props;
  return (
    <div className="single-tweet">
      <div className="tweet-owner-image">
        <img src={imageUrl} alt="img" />
      </div>
      <div className="tweet-body">
        <div className="tweet-owner-section">
          <div className="tweet-owner-name">{owner}</div>
          <div className="tweet-owner-username">@{username}</div>
          <div className="tweet-time">{timeStamp ? timeStamp : '2 saat'}</div>
        </div>
        <div className="tweet-content">
          <p>{tweetContent}</p>
          <div className="tweet-footer">
            <div className="tweet-button comment">
              <svg
                viewBox="0 0 24 24"
              ...
              {commentNumber ? commentNumber : '2711'}
            </div>
            <div className="tweet-button retweet">
              <svg
                viewBox="0 0 24 24"
                className="r-4qtqp9 r-yyyyoo r-1xvli5t r-dnmrzs r-bnwqim r-1plcrui r-lrvibr r-1hdv0qi"
              >
              ...
              {rtNumber ? rtNumber : '498'}
            </div>
            <div className="tweet-button favs">
              <svg
                viewBox="0 0 24 24"
